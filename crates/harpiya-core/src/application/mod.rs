...
//! use harpiya_core::application::{Application, Plugin};
//!
...
pub trait Application {
    ...
    /// It can also be specified by the environment variable `HARPIYA_APP_CONFIG_DIR`.
    #[inline]
    ...
    /// ```toml
    /// [dirs]
    /// data = "/data/harpiya" # an absolute path
    /// cache = "~/harpiya/cache" # a path in the home dir
...
static CONFIG_DIR: LazyLock<PathBuf> = LazyLock::new(|| {
    env::var("HARPIYA_APP_CONFIG_DIR")
        .map(PathBuf::from)
