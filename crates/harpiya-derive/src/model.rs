...
pub(super) fn parse_token_stream(input: DeriveInput) -> TokenStream {
    ...
    quote! {
        impl harpiya_core::model::Model for #name {
            ...
            #[must_use]
            fn read_map(&mut self, data: &harpiya_core::Map) -> harpiya_core::validation::Validation {
                use harpiya_core::extension::JsonObjectExt;

                let mut validation = harpiya_core::validation::Validation::new();
                if data.is_empty() {
