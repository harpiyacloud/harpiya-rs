...
//!
//! ```rust
//! use harpiya_storage::GlobalAccessor;
//! use harpiya_core::{error::Error, file::NamedFile};
//!
...
use toml::Table;
use harpiya_core::{application::StaticRecord, extension::TomlTableExt, state::State, LazyLock};
